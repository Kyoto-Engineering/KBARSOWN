...
{
    public partial class Particulers : Form
    {
        ...
        private void Particulers_Load(object sender, EventArgs e)
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string ct = "select distinct RTRIM(Transactions.Particulars) from Transactions  Where Transactions.Debit is not NULL";
